...
namespace Simi\MyFatoorahGraphql\Override\Controller;

use Magento\Sales\Model\Order;


class Index extends \MyFatoorah\MyFatoorahPaymentGateway\Controller\Checkout\AbstractAction {
    ...
    protected function getOrder() {
        ...
        if (isset($_GET['order_id']))
            $this->_checkoutSession->setLastRealOrderId($_GET['order_id']);
    ...
    public function execute() {
        ...
        try {
            ...
            if ($order->getState() === Order::STATE_CANCELED) {
                ...
                $order->addStatusHistoryComment('The customer was redirected to MyFatoorah');
                $order->save();
...
//---------------------------------------------------------------------------------------------------------------------------------------------------
    ...
    private function postToCheckout($order) {
        ...
        $cards = $this->_gatewayConfig->getPaymentGateways();
